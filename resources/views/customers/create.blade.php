...
<div class="max-w-lg mx-auto space-y-6">
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Tambah Pelanggan</h1>
    </div>
        ...
        <form action="{{ route('customers.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="address" rows="3"
                    class="w-full px-3 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm resize-none">{{ old('address') }}</textarea>
            </div>
