...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-2">Payment Methods Management</h1>
            <p class="text-gray-600 dark:text-gray-300">Manage your payment methods efficiently</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 flex flex-col md:flex-row justify-between items-center">
                ...
                <a href="{{ route('payment.create') }}" class="px-5 py-2.5 bg-white text-blue-600 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white transition-colors flex items-center shadow-md">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-3">
                                        <a href="{{ route('payment.edit', $paymentMethod->id) }}"
                                        ...
                                        <form action="{{ route('payment.destroy', $paymentMethod->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" 
            ...
            <!-- Pagination - Only show if pagination exists -->
